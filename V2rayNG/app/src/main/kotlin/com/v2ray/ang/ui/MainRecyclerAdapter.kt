...
class MainRecyclerAdapter(val activity: Activity,mainViewModel: MainViewModel) : RecyclerView.Adapter<MainRecyclerAdapter.BaseViewHolder>()
...
//                && mainViewModel.subscriptionId != config.subscriptionId
//            ) {
